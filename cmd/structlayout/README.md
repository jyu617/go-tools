...
```
go get github.com/jyu617/go-tools/cmd/structlayout
go get github.com/jyu617/go-tools/cmd/structlayout-pretty
go get github.com/jyu617/go-tools/cmd/structlayout-optimize
```
